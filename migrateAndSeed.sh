...
psql -U dundermiffling -d concretti -f ./migrations/001.do.create_users.sql
psql -U dundermiffling -d concretti -f ./migrations/002.do.create_products.sql
psql -U dundermiffling -d concretti -f ./migrations/003.do.create_orders.sql
